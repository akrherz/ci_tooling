...
sudo systemctl status postgresql@11-main.service || true
sudo systemctl stop postgresql@11-main.service || true
...
sudo cp postgres_files/pg_hba.conf /etc/postgresql/11/main/pg_hba.conf
